<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <ul class="navbar-nav navbar-right">
        <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link nav-link-lg message-toggle beep"><i
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <form id="logout" action="{{ route('logout') }}" method="post">
                    ...
                    <a onclick="event.preventDefault(); document.getElementById('logout').submit();"
                       href="{{ route('logout') }}" class="dropdown-item has-icon text-danger">
